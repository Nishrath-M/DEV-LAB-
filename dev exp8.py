...
india_districts_data_geo = india_districts_data_geo.merge(india_districts_data, how='left',
on='District')
# Plot the Maps
...
india_districts_data_geo.plot(column='Value', ax=axs[2], legend=True, cmap='coolwarm',
legend_kwds={'label': "Value by District"})
plt.tight_layout()
plt.show()
